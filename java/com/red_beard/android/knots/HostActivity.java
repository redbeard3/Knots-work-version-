...
public class HostActivity extends AppCompatActivity
    ...
    public static Intent newIntent (Context packageContext, int pos){
        Intent intent = new Intent(packageContext, HostActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                Intent searchIntent = SearchHostActivity.newSearchIntent(HostActivity.this, query);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_climb) {
            Intent intent = HostActivity.newIntent(HostActivity.this, 0);
            startActivity(intent);
        } else if (id == R.id.nav_sea) {
            Intent intent = HostActivity.newIntent(HostActivity.this, 1);
            startActivity(intent);
        } else if (id == R.id.nav_fish) {
            Intent intent = HostActivity.newIntent(HostActivity.this, 2);
            startActivity(intent);
            ...
            Intent intent = HostActivity.newIntent(HostActivity.this, 6);
            startActivity(intent);
        } else if (id == R.id.nav_favorite) {
            Intent intent = HostActivity.newIntent(HostActivity.this, 7);
            startActivity(intent);
        } else if (id == R.id.nav_source) {
            Intent sourceIntent = SourceActivity.newIntent(HostActivity.this);
